...
*/
void luai_writestring(struct lua_State* L, const char* string, size_t length);
void luai_writeline(struct lua_State* L);
#endif
...
*/
void luai_writestringerror(struct lua_State* L, const char* format, const char* param);
